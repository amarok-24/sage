    ...
    return (
      <div className="w-full mt-8 space-y-8">
        <div className="text-center space-y-3">
          <h2 className="text-xl sm:text-2xl font-sans font-medium text-[var(--nova-text-primary)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card icon={<CheckCircle2 className="w-5 h-5 text-[var(--nova-violet)]" />} title="Habits & Time">
            <p className="text-sm font-sans italic text-[var(--nova-text-primary)]">&quot;I ran for 30 minutes and read 10 pages of my book.&quot;</p>
          </Card>

          <Card icon={<Utensils className="w-5 h-5 text-orange-400" />} title="Nutrition">
            <p className="text-sm font-sans italic text-[var(--nova-text-primary)]">&quot;For lunch, I had a chicken salad with olive oil dressing.&quot;</p>
          </Card>

          <Card icon={<Wallet className="w-5 h-5 text-amber-400" />} title="Expenses">
            <p className="text-sm font-sans italic text-[var(--nova-text-primary)]">&quot;Spent $45 on groceries at Trader Joe&apos;s.&quot;</p>
          </Card>

          <Card icon={<HeartPulse className="w-5 h-5 text-red-400" />} title="Mood & Sleep">
            <p className="text-sm font-sans italic text-[var(--nova-text-primary)]">&quot;Slept 7 hours but feeling a bit anxious today. Mood is 6/10.&quot;</p>
          </Card>
        </div>
      </div>
    );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {item.data.journal && (
                  <Card icon={<BookOpen className="w-5 h-5 text-[var(--nova-cyan)]" />} title="Journal" className="md:col-span-2">
                    <p className="text-sm font-sans italic text-[var(--nova-text-primary)]">&quot;{item.data.journal.summary_snippet}&quot;</p>
