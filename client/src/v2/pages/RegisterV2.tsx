...
export function RegisterV2() {
  ...
  return (
    <NovaShell fallbackPath="/register">
      <div className="min-h-[80vh] flex flex-col items-center justify-center">
        <div className="w-full max-w-sm">
          <div className="flex flex-col items-center mb-8">
            <NovaLogo size={48} className="mb-4" />
            <h1 className="text-2xl sm:text-3xl font-nova font-semibold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[var(--nova-violet)] to-[var(--nova-cyan)]">
              Sage
            </h1>
            <p className="text-[var(--nova-text-muted)] font-nova mt-1">Grow your awareness.</p>
          </div>
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full min-h-[44px] rounded-xl bg-[var(--nova-bg)]/40 border border-[var(--nova-border)] px-3 py-2 font-nova text-[var(--nova-text-primary)] outline-none focus:border-[var(--nova-violet)] focus:ring-2 focus:ring-[var(--nova-violet)]/30"
                autoComplete="name"
                required
              />
            </div>
            ...
            <button
              ...
              className="w-full min-h-[44px] rounded-xl bg-gradient-to-r from-[var(--nova-violet)] to-[var(--nova-cyan)] text-white py-2.5 font-medium shadow-nova-glow transition-opacity hover:opacity-90 disabled:opacity-50"
            >
